...
export default function StickyCTABar() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex items-stretch bg-primary shadow-[0_-4px_24px_rgba(0,32,69,0.15)] md:hidden">
      ...
      >
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-[18px] h-[18px] text-secondary-container shrink-0" aria-hidden="true">
        ...
        <div>
          ...
          <div className="font-headline font-bold text-[13px] text-white">+242 06 990 56 40</div>
        </div>
      </a>
